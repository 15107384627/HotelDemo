...
<body
	style="background-color: #1c77ac; background-image: ${pageContext.request.contextPath}/public/url(images/light.png); background-repeat: no-repeat; background-position: center top; overflow: hidden;">
	...
	<div class="loginbody">
		...
		<div class="loginbox">
			...
			<ul>
				<li><input id="username" name="username" type="text" class="loginuser" value="admin"
					onclick="JavaScript:this.value=''" /></li>
				<li><input id="password" name="password" type="text" class="loginpwd" value="密码"
					onclick="JavaScript:this.value=''" /></li>
				<li><input name="" type="button" class="loginbtn" value="登录"
					onclick="login()" /><label><input
	...
	<div class="loginbm">
		版权所有 2013 <a href="http://www.mycodes.net">源码之家</a>
	</div>
